...
export const NavBar = () => {
    ...
    const [activeLink, setActiveLink] = useState("evelyn");
    const [isScrolled, setIsScrolled] = useState(false);

    //Function to smoothly scroll to a section by it's ID
    ...
    //function to dertermine the active section while scrolling
    ...
    return (
        <nav className={isScrolled ? "scrolled" : ""}>
            <div className="container">
                <div className = "row">
                    <div className ="evelyn">Evelyn</div>
